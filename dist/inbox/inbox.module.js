...
exports.InboxModule = InboxModule = __decorate([
    (0, common_1.Module)({
        imports: [prisma_module_1.PrismaModule, auth_module_1.AuthModule, redis_module_1.RedisModule, vendor_module_1.VendorModule],
        providers: [inbox_gateway_1.InboxGateway, inbox_service_1.InboxService],
        controllers: [inbox_controller_1.InboxController],
        exports: [inbox_gateway_1.InboxGateway],
    })
], InboxModule);
