...
exports.ReviewKycDto = exports.KycAction = void 0;
const class_validator_1 = require("class-validator");
var KycAction;
(function (KycAction) {
    KycAction["APPROVE"] = "APPROVE";
    KycAction["REJECT"] = "REJECT";
})(KycAction || (exports.KycAction = KycAction = {}));
class ReviewKycDto {
}
exports.ReviewKycDto = ReviewKycDto;
__decorate([
    (0, class_validator_1.IsEnum)(KycAction, {
